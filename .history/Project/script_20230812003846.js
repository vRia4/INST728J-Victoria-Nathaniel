...
function validate2() {
    ...
    if( document.myForm.turn.value == "Submit" ) {
        alert( "Thanks for contacting us. You message has been recorded. Our response will be sent to your email" );
        document.myForm.turn.focus() ;
        return false;
    }
}
...
function handleSubmit() {
    ...
    message.innerHTML = "Thanks for contacting us. You message has been recorded. Our response will be sent to your email";
}
